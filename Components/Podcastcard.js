...
class Podcastcard extends Component {
  ...
  calculateCardSize() {
    ...
    const cardSize = width / 3; // Adjust padding/margin
    return cardSize;
  }
  ...
  render() {
    ...
    return (
      <View style={[styles.card, { width: cardSize, height: cardSize * 1.2 }]}>
        <TouchableOpacity onPress={this.toggleWebView}>
          <View style={styles.contentContainer}>
            <Image source={{ uri: imageUrl }} style={styles.image} />
            <View style={styles.textContainer}>
              <Text numberOfLines={2} style={styles.description}>Web Podcast</Text>
            </View>
          </View>
