...
class Ddhiyanam extends Component {
  state = {
    dhiyanams: [],
    isLoading: true,
  ...
  fetchDhiyanams = async () => {
    try {
      const snapshot = await firestore.collection('dhiyanam').get();
  ...
  handleDelete = async (id) => {
    try {
      await firestore.collection('dhiyanam').doc(id).delete();
  ...
  handleSave = async () => {
    ...
    try {
      await firestore.collection('dhiyanam').doc(selectedDhiyanam.id).update({
        title,
        imageUrl,
        songUrl,
        times,
  ...
  render() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        <Menubar />
        <TouchableOpacity style={styles.button} onPress={() => this.props.navigation.navigate('Adhiyanam')}>
            <Text style={styles.buttonText}>Add Dhiyanam</Text>
          </TouchableOpacity>
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.modalContainer}>
              <Text style={styles.modalTitle}>Edit Dhiyanam</Text>
