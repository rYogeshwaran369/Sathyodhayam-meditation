  ...
  render() {
    ...
    return (
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {/* News Feeds */}
        <Headings subtitle="Headlines of" title="Master Sri Ji" />

        {/* Check if Newsdata is defined and not empty before mapping */}
        <View style={styles.list}>
          {Newsdata._j && Newsdata._j.length > 0 ? (
            ...
            <Text>No news available</Text> // Handle the case when Newsdata is empty or undefined
          )}
        </View>
